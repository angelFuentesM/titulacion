      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active" >
            <a class="nav-link" href="Ad_ciclos.php active" >Ciclos</a>
          </li>
  ...
  <div class="container" >
    ...
    <div id="egresado">
      <div class="row">
        <div class="col-md-12">
          <fieldset>
            <legend class="leyenda"><span class="numero">C</span>INGRESE NUEVO CICLO</legend>


            <!--Inicia Formulario-->
            <form action="reg_ciclos.php" method="POST" class="form-horizontal" id="guardar">
              <input type="text" value="guardar" name="opc" hidden>
              

              <div class="row">
                <div class="form-group col-md-3">                  
                 <input type="text" name="ciclo" class="form-control form-control-sm" id="ciclo" placeholder="Eje.Enero-Julio-2000">
               </div>                
              ...
              <table class="table table-sm">
                ...
                <tbody>
                  ...
                  try {
                    ...
                    $consultausuarios = "SELECT * FROM ciclos";
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Modificar Ciclo</h5>
